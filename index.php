                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-4"><!--ชั้น 1 -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=โถงอ่านหนังสือชั้น 1&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                    ...
                                    <div class="col-md-4"><!--ชั้น 2 -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=โถงอ่านหนังสือชั้น 2&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                    ...
                                    <div class="col-md-4"><!--ชั้น 3 -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=IT-Zone&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4"><!--ตึกเก่า ชั้น 1 -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=งานซ่อมฯ&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                    ...
                                    <div class="col-md-4"><!--ตึกเก่า ชั้น 2 -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=ที่นั่งอ่านหนังสือด้านตะวันออก&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                                include "panel/panel_gaugechart_dustFlob2.php";
                                                ?>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-4"><!--เทคโน -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=ห้องกราฟิกและสื่อสิ่งพิมพ์ดิจิทัล&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                                include "panel/panel_gaugechart_dustFltechno.php";
                                                ?>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4"><!--สำนักงานเลขานุการ -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=สำนักงานเลขานุการ&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                                include "panel/panel_gaugechart_dustFlsecret.php";
                                                ?>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-4"><!--หน้าอาคาร -->
                                        <div class="pmvalbox">
                                            <a href="/reportbydate.php?posname=หน้าอาคารสำนักวิทยบริการ&date=<?= date('Y-m-d') ?>" target="_blank">
                                                <?php
                                                include "panel/panel_gaugechart_dustoutside.php";
                                                ?>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class='form-control' id='searchword_posid' style="width:200px;" name='searchword_posid' required=''>
                                                ...
                                                <option value='23'>ห้องกราฟิกและสื่อสิ่งพิมพ์ดิจิทัล</option>
...
<img style='display:none' src='http://kaekae.oas.psu.ac.th/counter/counter.php?user=ddr&bgcolorR=225&bgcolorG=255&bgcolorB=253&=&fgcolorR=0&fgcolorG=0&fgcolorB=0'>
<!-- Footer -->