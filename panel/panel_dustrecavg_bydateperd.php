...
<?php
$sql = "SELECT avg(dustrec_amount_dust),avg(dustrec_temp),avg(dustrec_moistness),avg(dustrec_amount_co2) from dustrec as a, position as b 
                                    where 
...
$row_result_dayperd = mysqli_fetch_array($query, MYSQLI_ASSOC);

//aqi
$aqiVal = number_format((float)(aqiCal($row_result_dayperd['avg(dustrec_amount_dust)'])), 2, '.', '');
if ($aqiVal <= 50) {
  $aqiClass = 'aqi_god';
  $aqiDcrt = 'อากาศดี';
} else if ($aqiVal <= 100) {
...
<div class="row">
  <div class="col-md-6">
    <div class="update-nag"><!--ฝุ่น-->
      ...
      <div class="update-textdata"><?php echo number_format((float)$row_result_dayperd['avg(dustrec_amount_dust)'], 2, '.', ''); ?></div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="update-temp"><!--อุณหภูมิ-->
      ...
      <div class="update-textdata"><?php echo number_format((float)$row_result_dayperd['avg(dustrec_temp)'], 2, '.', ''); ?> </div>
    </div>
  </div>
</div>
<div class="row">
  <div class="col-md-6">
    <div class="update-mois"><!--ความชื้น-->
      ...
      <div class="update-textdata"><?php echo number_format((float)$row_result_dayperd['avg(dustrec_moistness)'], 2, '.', ''); ?> </div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="update-co2"><!--ก๊าชคาร์บอนไดออกไซค์-->
      ...
      <div class="update-textdata"><?php echo number_format((float)$row_result_dayperd['avg(dustrec_amount_co2)'], 2, '.', ''); ?> </div>
    </div>
  </div>
</div>