<?php
$sql = "SELECT dustrec_amount_dust FROM dustrec WHERE dustrec_position_id = '3' ORDER BY dustrec_id desc LIMIT 1"; //dustrec_position_id 3 โถงอ่านหนังสือชั้น 1
...
<figure class="highcharts-figure">
  ...
  <p class="highcharts-description text-center">
    ตำแหน่ง โถงอ่านหนังสือชั้น 1<br>[CC:5X:XX:XX:X3:AF]
    <br>
