<?php
$sql = "SELECT dustrec_amount_dust FROM dustrec WHERE dustrec_position_id = '9' ORDER BY dustrec_id desc LIMIT 1"; //dustrec_position_id 9 โถงอ่านหนังสือชั้น 2
...
<figure class="highcharts-figure">
  <div id="containerFl2"></div>
  <p class="highcharts-description text-center">
    ตำแหน่ง โถงอ่านหนังสือชั้น 2<br>[E8:9X:XX:XX:X4:B3]
    <br>
...
<script>
  Highcharts.chart('containerFl2', {
    ...
    title: {
      text: 'อาคารสำนักวิทยบริการ ชั้น 2<!--<br><span class="pmval">[<?= $pm ?> µg/m³]</span>-->'
    },
