...
<figure class="highcharts-figure">
    <div id="containerFlsecret"></div>
    <p class="highcharts-description text-center">
        ตำแหน่ง สำนักงานบริหาร<br>[34:9X:XX:XX:XA:20]
        <br>
    <div style="visibility: unset;" class="<?= $aqiClass ?>">AQI <?= $aqiVal ?> <?= $aqiDcrt ?></div>
    </p>
</figure>
...
<!-- <script>
    Highcharts.chart('containerFlsecret', {
            ...
            title: {
                text: 'สำนักงานบริหาร<br><span class="pmval">[<?= $pm ?> µg/m³]</span>'
            },
...
<script>
    Highcharts.chart('containerFlsecret', {
        ...
        title: {
            text: 'อาคารสำนักวิทยบริการ ชั้น 1<!--<br><span class="pmval">[<?= $pm ?> µg/m³]</span>-->'
        },
