                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h2 class="panel-title"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;สถานะสภาพอากาศ ตำแหน่ง <?= $_SESSION["SEARCHQUERY_POSNAME"] ?> วันที่
                                    ...
                                    <?php
                                    if ($_SESSION["SEARCHQUERY_DATE"]) {
                                        echo date("d/m/Y", strtotime($_SESSION["SEARCHQUERY_DATE"]));
                                    ...
                                    $onclick = "https://ddr.oas.psu.ac.th/dashboard/reportbydate.php?posname=" . $_SESSION["SEARCHQUERY_POSNAME"] . "&date=" . date("Y-m-d");
                                    ?>
                                </h2>
                                ...
                                <form class="form-inline text-right" method="GET" action="" style="margin-top:-20px">
                                    <div class="form-group">
                                        ...
                                        <select class='form-control' id='searchword_posid' style="" name='posname' required=''>
                                            ...
                                            <option value='ห้องกราฟิกและสื่อสิ่งพิมพ์ดิจิทัล'>ห้องกราฟิกและสื่อสิ่งพิมพ์ดิจิทัล</option>
                                            <option value='โรงพิมพ์ฝ่ายเทคโนโลยีและนวัตกรรมฯ'>โรงพิมพ์ฝ่ายเทคโนโลยีและนวัตกรรมฯ</option>
                                            <option disabled>*อื่นๆ</option>
                                            <option value='หน้าอาคารสำนักวิทยบริการ'>หน้าอาคารสำนักวิทยบริการ</option>
