...
?>
    ...
    ?>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5">
                    <h3><span class="text-info"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;ข้อมูลปริมาณฝุ่นละออง<br>
                            <h4>วันที่ <?= $searchword; ?> ตำแหน่ง <?= $_SESSION['posname']; ?></h4>
                        </span></h3>
                </div>
                <!--<div class="col-md-3">
                    ...
                    <table id="dustdatatable" class="table table-striped table-hover table-responsive">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <center>ปริมาณก๊าชคาร์บอนไดออกไซค์</center>
                                </th>
                                <th>
                                    <center>บันทึกข้อมูล</center>
                                </th>
                                <th>
                                        ...
                                        <td width="10%">
                                            <center>
                                                <div class="col-md-6 text-right">
                                                    <a href="?dustrec_id=<?php echo $row_result['dustrec_id'] ?>" rel="tooltip" title="แก้ไข" data-placement="top">
                                                        <h4><span class="text-info"><span class="glyphicon glyphicon-edit"></span></span></h4>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 text-left">
                                                    <a href="include/dustrec_del.php?dustrec_id=<?php echo $row_result['dustrec_id'] ?>" rel="tooltip" title="ลบ" data-placement="top" data-toggle='modal'>
                                                        <h4><span class="text-danger"><span class="glyphicon glyphicon-trash"></span></span></h4>
                                                    </a>
                                                </div>
                                            </center>
                                        </td>
